            ...
            <BarChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: -16 }}>
              <defs>
                <linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor={theme.categoryColors[0]} stopOpacity={0.85} />
                  <stop offset="100%" stopColor={theme.categoryColors[1]} stopOpacity={0.3} />
                </linearGradient>
              </defs>
            ...
            <AreaChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: -16 }}>
              <defs>
                <linearGradient id={areaGradientId} x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor={theme.categoryColors[0]} stopOpacity={0.15} />
                  <stop offset="100%" stopColor={theme.categoryColors[1]} stopOpacity={0.02} />
                </linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" vertical={false} />
              <XAxis {...axisProps} />
